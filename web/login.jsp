            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-4 offset-sm-4 border bg-main py-2 border-radius-top">
                        <p class="m-0 text-bold text-center">SIGN IN</p>
                    </div>
                    ...
                    <div class="col-12 col-sm-4 offset-sm-4 border px-3 border-radius-bottom">
                        <form action="MainController" method="POST">
                            ...
                            <div class="form-group my-2 ml-2">
                                <input type="password" placeholder="Password" class="form-control" name="txtPassword" required maxlength=50>
                            </div>
                            <input type="submit" class="btn btn-main btn-block m-1" value="Login" name="action">
                        </form>
                        <a class="btn m-1 btn-block" href="register.jsp">Create Account</a>
                </div>
            </div>
        </div>
    </body>
